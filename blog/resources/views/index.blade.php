 ...
 @section('content')
    ...
    <div class="product-list">
        <ul class="nav nav__product-list" id="lp-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="tab-one" data-toggle="tab" href="#tab1" role="tab"
            ...
            <li class="nav-item">
                <a class="nav-link" id="tab-three" data-toggle="tab" href="#tab3" role="tab"
            ...
            <li class="nav-item">
                <a class="nav-link" id="tab-six" data-toggle="tab" href="#tab6" role="tab" aria-controls="tab6"
                   aria-selected="false">User Interface</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab-seven" data-toggle="tab" href="#tab7" role="tab"
                   aria-controls="tab7" aria-selected="false">Landing Page</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab-eight" data-toggle="tab" href="#tab8" role="tab"
